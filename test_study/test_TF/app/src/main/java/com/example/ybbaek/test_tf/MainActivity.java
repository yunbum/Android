package com.example.ybbaek.test_tf;
...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String MODEL_FILE = "file:///android_asset/freeze2.pb";
    private static final String INPUT_NODE = "X";
    private static final String OUTPUT_NODE = "op_restore";

    private static final int[] INPUT_SIZE = {1}; //{3, 1}
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View button = findViewById(R.id.btn_run);
